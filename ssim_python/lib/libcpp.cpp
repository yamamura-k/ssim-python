...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("ssim_batch_recursive_new1", &_ssim_batch_recursive, "_ssim_batch_recursive_new1");
  m.def("ssim_batch_recursive_new2", &_ssim_batch_recursive, "_ssim_batch_recursive_new2");
